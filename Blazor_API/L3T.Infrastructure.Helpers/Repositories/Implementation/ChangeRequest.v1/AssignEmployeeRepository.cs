...
{
    public class AssignEmployeeRepository : BaseRepository<AssignToEmployeeInfo>, IAssignEmployeeRepository
    {
        public AssignEmployeeRepository(ChangeRequestDataContext dbContext) : base(dbContext)
        {
