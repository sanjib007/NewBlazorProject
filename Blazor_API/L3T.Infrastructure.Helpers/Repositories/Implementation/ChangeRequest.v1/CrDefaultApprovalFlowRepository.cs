...
{
    public class CrDefaultApprovalFlowRepository : BaseRepository<CrDefaultApprovalFlow>, ICrDefaultApprovalFlowRepository
    {
        public CrDefaultApprovalFlowRepository(ChangeRequestDataContext dbContext) : base(dbContext)
        {
