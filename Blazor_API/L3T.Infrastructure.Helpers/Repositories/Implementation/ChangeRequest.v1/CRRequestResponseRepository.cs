...
{
    public class CRRequestResponseRepository : BaseRepository<CRRequestResponseModel>, ICRRequestResponseRepository
    {
        public CRRequestResponseRepository(ChangeRequestDataContext dbContext) : base(dbContext)
        {
