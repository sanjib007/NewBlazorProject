...
{
    public class ChangeRequestLogRepository : BaseRepository<ChangeRequestLog>, IChangeRequestLogRepository
    {
        public ChangeRequestLogRepository(ChangeRequestDataContext dbContext) : base(dbContext)
        {
