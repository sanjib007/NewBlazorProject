...
{
    public class CrAttatchedFilesRepository : BaseRepository<CrAttatchedFile>, ICrAttatchedFilesRepository
    {
        public CrAttatchedFilesRepository(ChangeRequestDataContext context) : base(context)
        {
        }
    }
}
