...
{
    public class NotificationDetailsRepository : BaseRepository<NotificationDetails>, INotificationDetailsRepository
    {
        public NotificationDetailsRepository(ChangeRequestDataContext dbContext) : base(dbContext)
        {
