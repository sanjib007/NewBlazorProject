...
{ 
    public class ChangeRequestedInfoRepository : BaseRepository<ChangeRequestedInfo>, IChangeRequestedInfoRepository
    {
        public ChangeRequestedInfoRepository(ChangeRequestDataContext dbContext) : base(dbContext)
        {
