...
function getInputValues(param_ipv6AddressBlock, param_ipv6SubnetBitsVsNoOfSubnets) {
	...
	ipv6AddressBlock = param_ipv6AddressBlock;
	subnetBitsElement = param_ipv6SubnetBitsVsNoOfSubnets;
...
function calculateAndUpdateValues(action) {
	var ipv6AddressBlock = document.getElementById('ipv6AddressBlock').value;
	var subnetBitsElement = document.getElementById('ipv6SubnetBitsVsNoOfSubnets');
	...
	var totalbits = 0,
		...
		hostbits = 0,
		subnetbits = 0;
	var inputValuesMap = getInputValues(ipv6AddressBlock, subnetBitsElement);
