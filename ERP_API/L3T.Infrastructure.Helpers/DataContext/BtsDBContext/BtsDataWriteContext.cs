...
{
    public class BtsDataWriteContext : DbContext
    {
        public BtsDataWriteContext(DbContextOptions<BtsDataWriteContext> options) : base(options)
        {
        }
...
// Add-Migration init -Context L3T.Infrastructure.Helpers.DataContext.BtsDBContext.BtsDataWriteContext
// Update-Database -Context L3T.Infrastructure.Helpers.DataContext.BtsDBContext.BtsDataWriteContext