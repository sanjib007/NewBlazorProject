...
using L3TIdentityOAuth2Server.Helper;
using L3TIdentityOAuth2Server.Pagination;
using L3TIdentityOAuth2Server.Pagination.Helper;
...
public class AccountService : IAccountService
{
    ...
    public AccountService(IdentityTokenServerDBContext context, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, RoleManager<AppRoles> roleManager, IUriService uriService, IMapper mapper)
    {
        _context = context;
