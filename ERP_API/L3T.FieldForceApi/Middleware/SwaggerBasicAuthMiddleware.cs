...
namespace L3T.FieldForceApi.Middleware
{
    public class SwaggerBasicAuthMiddleware
    {
        ...
        public bool IsAuthorized(string username, string password)
        {
            ...
            return username.Equals(_configuration.GetValue<string>("Swagger:UserName"), StringComparison.InvariantCultureIgnoreCase)
                    && password.Equals(_configuration.GetValue<string>("Swagger:Password"));
        }
